...
public class BRelation<K, V> extends BSet<Pair<K, V>> {
	public static BRelation EMPTY = new BRelation();
		 ...
		 */
		public static <KK, VV> BRelation<KK, VV> singleton(KK key, VV value) {
	     ...
	     */
		public static <KK, VV> BRelation<KK, VV> singleton(Pair<KK, VV> pair) {
		 ...
		 */
		public BRelation<K, V> insert(Pair<K, V> pair) {
		...
		/*@ requires true;
		 	assignable \nothing;
		 */
		public BRelation<K, V> union(BSet<Pair<K, V>> otherRel) {
			if (otherRel instanceof ID) {
		...
		/*@ requires true;
		 	assignable \nothing;
	     */
		public BRelation<K, V> intersection(BSet<Pair<K, V>> otherRel) {
			if (otherRel instanceof ID) {
		...
		/*@ requires true;
		 	assignable \nothing;
	     */
		public BRelation<K, V> difference(BSet<Pair<K, V>> otherRel) {
			BRelation<K, V> res = new BRelation<K,V>();
			res.addAll(this);
	     ...
	     */
		public Iterator<Pair<K, V>> associations() {
	    ...
	    /*@ requires true;
	     	assignable \nothing;
	      */
	    public BSet<Pair<K, BSet<V>>> imagePairSet() {
	     ...
	     */
	    public Iterator<Pair<K,V>> imagePairs() {
	    	return super.iterator();
	    }
	     ...
	     */
	    public Iterator<K> domainElements() {
	     ...
	     */
	    public Iterator<V> rangeElements() {
	    	return range().iterator();
	    }
		
		/*@ requires true;
		 	assignable \nothing;
	        ensures \result.equals(this.domain());
	    */
		...
		/*@ requires true;
		 	assignable \nothing;
	        ensures \result.equals(this.range());
	    */
	     ...
	     */
	    public BRelation<K,V> toFunction() {
		...
		/*@ requires true;
		 	assignable \nothing;
		 */
		public <D> BRelation<K, Pair<V, D>> parallel(BRelation<K, D> other) {
		...
		/*@ requires true;
		 	assignable \nothing;
		 */
		public <K1, V1> BRelation<Pair<K, K1>, Pair<V, V1>> directProd(BRelation<K1, V1> other) {
	    ...
	    */
		...
		/*@ also 
		 	...
		 	assignable \nothing;
	     */
		public BSet<BSet<Pair<K, V>>> pow1() {
			return super.pow1();
		}
	    ...
	    /*@ requires true;
	     	assignable \nothing;
	     */
		public boolean isSubset(BSet<Pair<K, V>> other) {
			for(Pair<K,V> pair : this) {
		 ...
		 */
		public boolean isProperSubset(BSet<Pair<K, V>> other) {
			return this.isSubset(other) && !this.equals(other);
		}
				
		public Pair<K, V> choose() {
			if(isSingleton())
