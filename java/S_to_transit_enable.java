...
public class S_to_transit_enable{
	...
	public S_to_transit_enable(Raffinement2 m) {
		this.machine = m;
	}
	...
	public void run_S_to_transit_enable(){
		if(guard_S_to_transit_enable()) {
			...
			machine.set_transit_S_available((transit_S_available_tmp.override(new BRelation<Integer,Boolean>(new Pair<Integer,Boolean>(1,true)))));
			...
			System.out.println("S_to_transit_enable executed ");
		}
	}
