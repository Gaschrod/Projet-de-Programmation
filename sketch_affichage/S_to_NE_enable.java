...
public class S_to_NE_enable{
	...
	public S_to_NE_enable(Raffinement2 m) {
		this.machine = m;
	}
	...
	public void run_S_to_NE_enable(){
		if(guard_S_to_NE_enable()) {
			...
			machine.set_NE_S_available((NE_S_available_tmp.override(new BRelation<Integer,Boolean>(new Pair<Integer,Boolean>(2,true)))));
			...
			System.out.println("S_to_NE_enable executed ");
		}
	}
