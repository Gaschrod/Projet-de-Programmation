...
public class BSet<E> extends TreeSet<E> implements Comparable<E> {
	...
	*/
	public boolean isSubset(TreeSet<E> s2) {
	...
	*/
	public boolean isProperSubset(BSet<E> s2) {
	...
	*/
	public boolean isSuperset(BSet<E> s2) {
	...
	*/
	public boolean isProperSuperset(BSet<E> s2) {
	 ...
	 */
	public BSet<E> union(TreeSet<E> s2) {
		if (s2 instanceof INT) {
			return (BSet<E>) s2;
		} else if (s2 instanceof NAT || s2 instanceof NAT1) {
			for (Object obj : this) {
	...
	*/
	...
	/*@ requires true;
	 	assignable \nothing;
	 	ensures (\forall E e; \result.has(e) <==> this.has(e) && s2.contains(e));*/
	public BSet<E> intersection(TreeSet<E> s2) {
		if (s2 instanceof INT) {
	...
	*/
	...
	/*@ requires true;
	 	...
	 	ensures (\forall E e; \result.has(e) <==> this.has(e) && !s2.contains(e));
	*/
	public BSet<E> difference(TreeSet<E> s2) {
		if (s2 instanceof INT) {
	...
	public TreeSet<TreeSet<E>> powerSet() {
	...
	/*@ requires true;
	 	assignable \nothing;
	 	ensures \result.equals(this.pow().difference(new BSet<BSet<E>>()));
	*/
	...
	public static <E> boolean partition(BSet<E> ... parts) {
