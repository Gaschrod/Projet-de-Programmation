...
public class Raffinement2{
	...
	public static final Integer Tchou_tchou = Test_Raffinement2.random_Tchou_tchou;
	public static final Integer Kozma_Minin = Test_Raffinement2.random_Kozma_Minin;

	public static final Integer NOTHING = Test_Raffinement2.random_NOTHING;

	public static final Integer The_Whistling_Limited = Test_Raffinement2.random_The_Whistling_Limited;

	public static final Integer The_Orient_Express = Test_Raffinement2.random_The_Orient_Express;

	public static final Integer The_Steamy_Express = Test_Raffinement2.random_The_Steamy_Express;

	public static final Integer Orient_Express = Test_Raffinement2.random_Orient_Express;

	public static final Integer Thomas_the_tank = Test_Raffinement2.random_Thomas_the_tank;

	public static final Integer S = Test_Raffinement2.random_S;

	public static final Integer red = Test_Raffinement2.random_red;

	public static final BSet<Integer> Secondary_station = Test_Raffinement2.random_Secondary_station;

	public static final Integer NOTRAIN = Test_Raffinement2.random_NOTRAIN;

	public static final Integer NE = Test_Raffinement2.random_NE;

	public static final Integer NW = Test_Raffinement2.random_NW;

	public static final Integer BUSY = Test_Raffinement2.random_BUSY;

	public static final Integer SE = Test_Raffinement2.random_SE;

	public static final Integer SW = Test_Raffinement2.random_SW;

	public static final Integer green = Test_Raffinement2.random_green;

	public static final Integer center = Test_Raffinement2.random_center;

	public static final Integer station8 = Test_Raffinement2.random_station8;

	public static final Integer station4 = Test_Raffinement2.random_station4;

	public static final Integer station5 = Test_Raffinement2.random_station5;

	public static final Integer station6 = Test_Raffinement2.random_station6;

	public static final Integer station7 = Test_Raffinement2.random_station7;

	public static final Integer station1 = Test_Raffinement2.random_station1;

	public static final Integer station2 = Test_Raffinement2.random_station2;


	public static final Integer station3 = Test_Raffinement2.random_station3;

	public static final Integer transit = Test_Raffinement2.random_transit;

	public static final BSet<Integer> Main_station = Test_Raffinement2.random_Main_station;
