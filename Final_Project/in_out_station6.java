...
public class in_out_station6{
	...
	public boolean guard_in_out_station6( Integer temporary, Integer rail_value, Integer light_color, Integer secondary_lights) {
		return (machine.get_secondary_occupancy().apply(machine.station6).equals(machine.NOTHING) && !machine.get_SW_to_S().apply(new Integer(2)).equals(machine.NOTHING) || !machine.get_secondary_occupancy().apply(machine.station6).equals(machine.NOTHING) && machine.get_SW_to_S().apply(new Integer(2)).equals(machine.NOTHING) 
