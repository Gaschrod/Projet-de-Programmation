...
public class in_out_station3{
	...
	public boolean guard_in_out_station3( Integer temporary, Integer rail_value, Integer light_color, Integer secondary_lights) {
		return (machine.get_secondary_occupancy().apply(machine.station3).equals(machine.NOTHING) && !machine.get_center_to_NE().apply(new Integer(2)).equals(machine.NOTHING) || !machine.get_secondary_occupancy().apply(machine.station3).equals(machine.NOTHING) && machine.get_center_to_NE().apply(new Integer(2)).equals(machine.NOTHING) 
