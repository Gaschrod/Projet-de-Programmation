...
public class in_out_station5{
	...
	public boolean guard_in_out_station5( Integer temporary, Integer rail_value, Integer light_color, Integer secondary_lights) {
		return (machine.get_secondary_occupancy().apply(machine.station5).equals(machine.NOTHING) && !machine.get_S_to_SE().apply(new Integer(2)).equals(machine.NOTHING) || !machine.get_secondary_occupancy().apply(machine.station5).equals(machine.NOTHING) && machine.get_S_to_SE().apply(new Integer(2)).equals(machine.NOTHING) 
