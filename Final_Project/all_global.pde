...
Button NW_to_NE_railway = new Button("NW to NE railway", 930, 945, 110, 20);
Button NE_to_NW_railway = new Button("NE to NW railway", 1040, 945, 110, 20);
Button NW_to_SW_railway = new Button("NW to SW railway", 1150, 945, 110, 20);
Button SW_to_NW_railway = new Button("SW to NW railway", 50, 975, 110, 20);
