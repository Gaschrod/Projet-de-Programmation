...
Button avance_transit_to_center = new Button("Transit -> Center", 710, 880, 100, 20);
Button avance_center_to_transit = new Button("Center -> Transit", 820, 880, 100, 20);
Button avance_SW_to_transit = new Button("SW -> Transit", 930, 880, 100, 20);
Button avance_transit_to_SW = new Button("Transit -> SW", 1040, 880, 100, 20);
Button avance_S_to_transit = new Button("S -> Transit", 1150, 880, 100, 20);
Button avance_transit_to_S = new Button("Transit -> S", 50, 910, 100, 20);
...
Button avance_center_to_S = new Button("Center -> S", 1040, 910, 100, 20);
Button avance_S_to_center = new Button("S -> Center", 1150, 910, 100, 20);
...
Button SW_to_transit_railway = new Button("SW-transit railway", 710, 945, 100, 20);
Button transit_to_SW_railway = new Button("transit-SW railway", 820, 945, 100, 20);
...
Button center_to_S_railway = new Button("Center-S railway", 1300, 880, 100, 20);
Button S_to_center_railway = new Button("S-Center railway", 1300, 910, 100, 20);
Button transit_to_center_railway = new Button("transit-Center railway", 1300, 945, 100, 20);
